...
elements that coffee shops offer.`,
  ...
  .`,
      github: `https://relaxed-lumiere-bcf387.netlify.app/`,
      website: `https://github.com/mahmoudadelmohamed/Front-end/tree/master/Small%20Projects/Bootstrap%20Website`
  },
]
class DetailsPage extends Component {
  ...
  render() {
    ...
    const { name, image, time, tools, overview, github, website } = specific_image[0];
    return (
      <>
        <Container fluid className="mt-5 container_height">
           <Row className="d-flex align-items-center">
            ...
            <Col lg={5} sm={12}>
              <Title title={name} sub_title={`since ${time}`} className="h1-2-light title_uppercase" />
              <ToolsList list={tools} title="Tools and Technologies" className="mb-xs-40" />
              <Paragraph title="overview" text={overview} className="mb-xs-40" />
