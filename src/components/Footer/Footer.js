...
/*add all icons and links in object and return it by map througb on it */
      ...
      <div className="container-fluid" id="content">
        <div className="row">
          <div className="col-md-6 footer-title py-5">
            <h1 className="text-center h1-2-light title_uppercase social_network">
              contact
            </h1>
          ...
          <div className="col-md-6 footer-contact text-center ">
            <h2 className="mb-4 h1-2-light title_uppercase text-center">
              Hire me
            </h2>
            <form>
              ...
              <div className="d-flex justify-content-center align-items-center">
                <button
                  type="submit"
                  className="btn btn-outline-pages text-center mb-3 w-100"
                >
                  Submit
                </button>
              </div>
